...
impl super::Instance {
    ...
    pub fn desired_extensions(
        ...
        // Mirante4D's opt-in presentation observer queries revision-3 timing
        // support on the real surface before creating its swapchain.
        if super::present_wait_observer::installed() {
