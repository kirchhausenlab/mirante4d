...
identities, strict control scalars, closed canonical-value and display-defaults
grammars, restricted JCS, and exact compatibility tuple bytes exist. The
profile, science, record, manifest, and release DTOs, shard/index I/O, reader,
